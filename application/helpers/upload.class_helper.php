...
class UploadHandler
{
    ...
    function __construct($options=null) {
		$CI =& get_instance();
        $this->options = array(
            'script_url' => $this->getFullUrl().'/transaction/upload',
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).$CI->session->userdata('FILE_PATH'),
            'upload_url' => $this->getFullUrl().$CI->session->userdata('FILE_PATH'),
            'param_name' => 'files',
