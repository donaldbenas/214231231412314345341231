	...
	<table class="table table-condensed table-hover table-bordered" id="processtable">
		<tr>
			...
			<td><b>Date Approve :</b> <?php $approved = $this->personalmodel->dateapprove($personalbackground[0]['appid']); if(!empty($approved)) echo date('M d, Y',strtotime($approved[0]['approve'])) ?></td>
		</tr>
		<tr>
