...
<link rel="stylesheet" href="<?php echo base_url()?>bootstrap-responsive.css">
<link rel="stylesheet" href="<?php echo base_url()?>css/jquery.fileupload-ui.css">
</head>
<body>

<div class="container">
    <form id="fileupload" action="<?php echo base_url()?>index.php/home/upload" method="POST" enctype="multipart/form-data">
